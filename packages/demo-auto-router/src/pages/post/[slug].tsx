  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h3
            style={{ fontSize: '16px', fontWeight: '600', color: '#1565c0', marginBottom: '10px' }}
          >
            当前路由参数
          </h3>
          <div style={{ fontSize: '14px', color: '#666' }}>
            <p style={{ margin: '0 0 8px 0' }}>
              <strong>文章 Slug:</strong> {slug}
            </p>
            <p style={{ margin: 0 }}>
        ...
        >
          <h4
            style={{ fontSize: '14px', fontWeight: '600', color: '#c2185b', marginBottom: '10px' }}
          >
            💡 尝试不同的文章
          </h4>
