  ...
  describe('MemoryRouter', () => {
    ...
    describe('go', () => {
      ...
      it('go(0) 应该不做任何操作', async () => {
        ...
        expect(router!.currentRoute.path).toBe(initialPath)
      })
    ...
    describe('push', () => {
      ...
      it('push 后再 push 应该清除后面的历史', async () => {
        ...
        router!.go(1)
        await new Promise(resolve => setTimeout(resolve, 20))
        expect(router!.currentRoute.path).toBe('/user/123')
      })
    })
    ...
    describe('动态路由', () => {
      ...
      it('动态路由参数应该正确传递', async () => {
        ...
        expect(router!.currentRoute.params.id).toBe('456')
      })
    ...
    describe('查询参数和 hash', () => {
      ...
      it('查询参数应该正确保存', async () => {
        ...
        expect(router!.currentRoute.query.b).toBe('2')
      })
